...
public class IpoApplication implements Serializable {
    ...
    public IpoApplication(int id, int clearingHouseId, int holderId, int initialPublicOfferId, String issuer, int sharesSubscribed, double amountPaid, String issuingHouse, double sharesSubscribedValue, int sharesAdjusted, double returnMoney, boolean processingPayment, boolean approved, boolean cancelled, String dateApplied, Holder holder) {
        this.id = id;
